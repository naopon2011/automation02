...
#  cc_count                  = var.cc_count
  ...
  mgmt_subnet_id            = var.private_subnet
  service_subnet_id         = var.private_subnet
  instance_key              = "zsdemo"
  user_data                 = base64encode(local.userdata)
...
#  service_security_group_id = module.cc_sg.service_security_group_id
   mgmt_security_group_id    = var.security_group
    service_security_group_id = var.security_group
}
